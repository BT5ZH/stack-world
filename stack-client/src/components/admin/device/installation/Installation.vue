  ...
  <a-row class="container">
    <a-row class="btn-area">
      <a-select
        ...
        @change="handleChange"
      >
        <a-select-option value="jack"> 全部教学楼 </a-select-option>
        <a-select-option value="lucy"> 主楼 </a-select-option>
        <a-select-option value="Tom"> 生化楼 </a-select-option>
        <a-select-option value="Yimi"> 多媒体微机室 </a-select-option>
        <a-select-option value="Gili"> 三教 </a-select-option>
      </a-select>
      <a-input-search
