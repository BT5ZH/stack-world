  ...
  <a-layout id="components-layout-demo-fixed">
    ...
    <a-layout-content :style="{ padding: '0 10px', marginTop: '64px' }">
      <a-breadcrumb :style="{ margin: '16px 0' }">
        <a-breadcrumb-item>设备升级页面</a-breadcrumb-item>
      </a-breadcrumb>
    </a-layout-content>
      ...
      <a-tree-node key="0-0">
        ...
        <a-tree-node key="0-0-0" title="主楼（20）">
          ...
          <a-tree-node key="0-0-0-0" title="1层（11）">
            <a-icon slot="icon" type="carry-out" />
            <a-tree-node key="0-0-0-0-1" title="1001">
            </a-tree-node>
            <a-tree-node key="0-0-0-0-2" title="1002">
            </a-tree-node>
            <a-tree-node key="0-0-0-0-3" title="1003">
            </a-tree-node>
            <a-tree-node key="0-0-0-0-4" title="1004">
            </a-tree-node>
          </a-tree-node>
          <a-tree-node key="0-0-0-1" title="2层（2）">
            <a-icon slot="icon" type="carry-out" />
            <a-tree-node key="0-0-0-1-1" title="2001">
            </a-tree-node>
            <a-tree-node key="0-0-0-1-3" title="2003">
            </a-tree-node>
          </a-tree-node>
    ...
    <a-layout-content :style="{ padding: '0 40px', minHeight: '580px' }">
    ...
    <a-row class="btn-area">
      ...
      <a-select default-value="lucy" :style="{ width: '250px'}" @change="handleChange">
