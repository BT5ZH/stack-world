<template>
  <div>
    ...
    <a-modal v-model="building_visible" title="添加教学楼" @ok="addBuilding">
      <a-select placeholder="请选择校区" @change="handleSelectChange" style="width: 100%;margin-bottom: 20px;">
    ...
    <a-tree :load-data="onLoadData" :tree-data="treeData" @select='showRooms' :show-line="true"
      :defaultExpandedKeys="['1']" />
    <div class="btn-area">
      <a-button-group>
        <a-button type="primary" @click='campus_visible = true'>+ 校区</a-button>
        <a-button type="primary" @click='building_visible = true'>+ 教学楼</a-button>
        <a-button type="primary" @click='editContent(currentInfo)'>编辑</a-button>
        <a-button type="primary" @click='deleteContent(currentInfo)'>删除</a-button>
      </a-button-group>
    </div>
  </div>
</template>
