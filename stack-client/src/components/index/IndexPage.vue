      ...
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input">
            <input class="input100" autocomplete="username" type="text" name="email" v-model="account"
              placeholder="手机号/邮箱" />
          ...
          <div class="wrap-input100 validate-input">
            <input class="input100" autocomplete="current-password" type="password" name="pass" v-model="password"
              placeholder="密码" />
            <span class="input-icon">
              <a-icon type="lock" />
            </span>
      ...
      updatePublicVuexData(context) {
        ...
        const publicVuexData = {
          ...
          const userData = {
            ...
            email: context.email,
            oid: context.org_id,
            oname:context.org_name,
            cid: context.class_id,
            phone: context.phone,
          };
