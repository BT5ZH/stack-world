  ...
  <div>
    <a-row class="btn-area">
      ...
      <a-col :span="2" class="btn">
        <a-button @click="addUniversityVisible = true" type="primary">添加学校</a-button>
        <a-modal
    ...
    <a-row class="collapse" >
      <a-col>
        <a-collapse v-model="activeKey" :expand-icon-position="expandIconPosition" height=20px>
...
export default {
  data() {
    return {
      ...
      editVisible: false,
      formRules: {
        universityName: [{ required: true, min: 2, message: "学校名称最少2个字" }],
