<template>
    <div style="width: 95%; margin: 1.2rem auto;">
        <div>
            ...
            <a-button :disabled="disableAttachmentButton" type="primary" icon="download" @click='download(homeworkItem.attachment_url)'>
                作业附件
            </a-button>
        ...
        <a-form-model
            ...
            <a-form-model-item label="答题框">
                <a-textarea  :disabled="disableCommentsArea" placeholder="请输入答案"
                             :auto-size="{ minRows: 6, maxRows: 8 }"
                             v-model="homeworkForm.content"> 
                </a-textarea>
            </a-form-model-item>
            <a-form-model-item label="老师评语">
                <a-textarea  disabled placeholder="老师什么都没说..."
            ...
            <a-form-model-item  label=" ">
                ...
                <a-button type="primary" @click="submitHomework">确定</a-button>
...
<script>
    ...
    export default {
        ...
        created: function () {
            ...
            if(this.homeworkItem.attachment_url ==="none" ) this.disableAttachmentButton=true 
